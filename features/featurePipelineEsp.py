...
common_voice["train"] = load_dataset("mozilla-foundation/common_voice_11_0", "es", split="test[:-100]", use_auth_token=True)
common_voice["test"] = load_dataset("mozilla-foundation/common_voice_11_0", "es", split="test[-100:]", use_auth_token=True)
print(common_voice)
...
#HuggingFace
common_voice.push_to_hub("dacavi/spanish-dataset")
